...
public sealed class GamePostProcessingRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        GamePostProcessingVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<GamePostProcessingVolumeComponent>();
