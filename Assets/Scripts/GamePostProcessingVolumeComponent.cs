...
[VolumeComponentMenu("Post-processing Custom/GamePostProcessing")]
[VolumeRequiresRendererFeatures(typeof(GamePostProcessingRendererFeature))]
[SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
public sealed class GamePostProcessingVolumeComponent : VolumeComponent, IPostProcessComponent
{
    public GamePostProcessingVolumeComponent()
    {
        displayName = "GamePostProcessing";
    }
